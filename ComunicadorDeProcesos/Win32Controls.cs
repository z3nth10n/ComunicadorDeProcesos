...
{
    internal class Win32WindowEvents
    {
        ...
        private static Func<Win32Window, bool> predicate;
    ...
    public static class WinAPI
    {
        ...
        private static extern System.UInt16 RegisterClassW([System.Runtime.InteropServices.In] ref WNDCLASS lpWndClass);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        private static extern IntPtr CreateWindowExW(UInt32 dwExStyle,
       ...
       string lpWindowName,
        ...
        private static IntPtr CreateWindow(string class_name, IntPtr hWndParent, WndProc CallBack, WindowStyles Style, WindowStylesEx ExStyle = WindowStylesEx.WS_EX_CLIENTEDGE)
        {
            IntPtr hWnd;
    ...
    public class Win32CheckBox : Win32Button
    {
        ...
        private void Win32CheckBox_Click(object sender, MouseEventArgs e)
        {
            Checked = !Checked;
        }

        private int BM_GETCHECK = 0xF0;
        private int BM_SETCHECK = 0xF1;
    ...
    public class Win32ListBox : Win32Window
    {
        ...
        private void Win32ListBox_KeyDown(object sender, KeyEventArgs e)
        {
            CheckChange();
        }

        private void Win32ListBox_MouseDown(object sender, MouseEventArgs e)
        {
            CheckChange();
        }

        private void Win32ListBox_MouseScroll(object sender, MouseEventArgs e)
        {
            if (e.Delta > 0)
            {
                if (SelectedItem != 0)
        ...
        private int LB_ADDSTRING = 0x0180;
        private int LB_GETCURSEL = 0x0186;
        private int LB_GETSEL = 0x0187;
        private int LB_GETCOUNT = 0x018B;
        private int LB_GETTEXT = 0x0189;
        private int LB_GETITEMDATA = 0x0199;
        private int LB_SETITEMDATA = 0x019A;
        private int LB_DELETESTRING = 0x0182;
    ...
    public class Win32Window
    {
        ...
        */
        ...
        private MouseButtons LastPressedButton;

        private MouseEventArgs CreateMouseEvent(MSG msg)
        {
        ...
        private KeyEventArgs CreateKeyEvent(MSG msg)
        {
        ...
        private static Win32Window everycontrol(Win32Window cursor, Func<Win32Window, bool> function)
        {
        ...
        private List<Win32Window> GetAllWindows()
        {
        ...
        [DllImport("uxtheme.dll", ExactSpelling = true, CharSet = CharSet.Unicode)]
        private static extern int SetWindowTheme(IntPtr hWnd, int pszSubAppName, String pszSubIdList);

        [DllImport("uxtheme.dll", ExactSpelling = true, CharSet = CharSet.Unicode)]
        private static extern int SetWindowTheme(IntPtr hWnd, String pszSubAppName, int pszSubIdList);

        [DllImport("uxtheme.dll", ExactSpelling = true, CharSet = CharSet.Unicode)]
        private static extern int SetWindowTheme(IntPtr hWnd, int pszSubAppName, int pszSubIdList);
